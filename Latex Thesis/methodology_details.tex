...
A key challenge in analyzing longitudinal Terms of Service data is the sparsity of document updates. Companies do not release a new ToS every year. To address this, a "Forward-Fill" imputation strategy was applied. If a document was released in a given year (e.g., 2020), its clauses were assumed to remain valid and in force for subsequent years (2021, 2022) until a new document was detected. This ensures that the dataset accurately reflects the \textit{active} regulatory environment in any given year, distinguishing between "missing data" and "persistent rules."
