...
The analysis reveals a strong positive correlation ($R > 0.8$) between the degree of price discrimination and the intensity of enforcement. This quantitatively supports the theoretical "Fortress" vs. "Globalist" distinction proposed in Chapter 5. Firms like \textbf{Disney+} and \textbf{Netflix} appear in the top-right quadrant (High Price Variation/High Protection), while \textbf{Microsoft 365} and \textbf{Apple Music} occupy the lower-left (Lower Price Variation/Lower Protection), confirming that coercive enforcement is a necessary cost of maintaining deep price discrimination.
