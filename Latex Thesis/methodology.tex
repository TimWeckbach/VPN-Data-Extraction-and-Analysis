...
The raw price data was processed in two stages. First, all local prices were converted to a common currency (USD) using market exchange rates to determine the "Nominal Price Inequality." Second, to assess "Real Affordability," these prices were calculated as a percentage of the \textit{Average National Monthly Wage} (sourced from OECD and World Bank data), providing a direct measure of the economic burden on the local consumer (`Price-to-Wage Ratio`). This approach was chosen over standard PPP adjustment to better reflect the specific affordability of subscription goods relative to disposable income.
