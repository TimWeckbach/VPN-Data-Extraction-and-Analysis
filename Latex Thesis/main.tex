...
\begin{abstract}
	...
	mixed-methods design, the study first measures the economic incentive for \gls{digitalgeoarbitrage}
...
\begin{itemize}
	...
	\item \textit{Legal Status:} Piracy is clearly illegal, while geo-arbitrage is a gray zone
	      \parencite{ariyarathna2022circumvention}.
...
observations (see Chapter~\ref{chap:methodology} for details on how missing data was handled).
